                    ...
                    if ( IWARM1 == 1 ):  # 一定除去熱量を計算する
                        ...
                        if (IREP == 0) or (ICHNG == 1):
                            for IZ in range(1, NZ+1):
                                ...
                                # COEFFP(IZ,KSTP,NZ,IREP,NSTP1,IDLT,VFLOW[1,IZ,JHR],PV[0,IZ],PR[0,IZ],CRHO[ISL],VOAWK[IZ,IREP,JHR],FIXEDL[IZ],RMSET,REFWD[ISL],ISL,LCG[IZ]+LSZSPC[0],LSZSPC,NA,NSIZE,AA,BB,IPS)
